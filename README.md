...
TCGA 全名為台灣電腦對局協會，基本上每年會舉辦兩場各類型的電腦對局比賽，當然也包括圍棋。TCGA 的圍棋比賽是使用 KGS 伺服器比賽的，如果你已經能順利掛載引擎到 KGS 上，恭喜你完成第一步比賽的準備。dlgo 還有不少可以改進的空間，接下來可以設法強化 dlgo，希望你能在比賽中獲得好成績。
